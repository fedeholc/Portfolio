  ...
  public static proyectos: Proyecto[] = [
    {
      ...
      enlace: 'https://github.com/fedeholc/',
      logo: 'assets/ap.jpg',
    },
  ];
  ...
  public static trabajos: Trabajo[] = [
    {
      ...
      logo: 'assets/Escudo-de-la-Ciudad-de-Buenos-Aires.png'
    },
    {
      id: 0,
    ...
    },
    {
      ...
      logo: 'assets/715px-UBA-svg.webp'
    },

    {
      ...
      logo: 'assets/service-custom-software-development.png'
    },
  ];
  ...
  public static idiomas: Idioma[] = [
    {
      ...
      nombre: 'Español',
      descripcion: 'Nativo',
      logo: 'assets/Flag-of-Spain-Civil.png',
    },
    {
      id: 0,
      nombre: 'Inglés',
      descripcion: 'First Certificate Exam, Cambridge University. Calificación: B',
      logo: 'assets/Flag-of-the-United-Kingdom.png',
    },
  ];
